...
#Generate a list of instructions from input file, use lambda function to strip off '\n' character from each line
...
# Generate list of data inputs to intialize the memory bus from.
# Use lambda duntion to strip off '\n' character from each line
def fetch_data():
...
print("Memory Bus from data inout file...")
print("---------------------------------------------------")
